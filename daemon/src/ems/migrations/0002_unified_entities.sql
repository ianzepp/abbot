...
--
-- Fixed columns: id, kind, status, priority, scope, prompt, created_at, updated_at, data
...
CREATE INDEX IF NOT EXISTS idx_entities
    ON "entities" ("kind", "status", "priority", "scope", "created_at");
...
INSERT INTO "entities" ("id", "kind", "status", "priority", "scope", "prompt", "created_at", "updated_at", "data")
SELECT
    "id",
    'task',
    "status",
