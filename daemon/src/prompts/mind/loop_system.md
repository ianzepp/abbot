...
- **Use preloaded context**: Current wants, pending needs, and running needs are already provided in your context below. Do NOT call `want_list` or `task_list` unless you need to refresh state after making changes.
